...
<body>
	...
	<div class="row-fluid">
        ...
        <div class="span7"><!--Navigation-->
          <ul id="nav">
            ...
            <li class="dropdown-submenu selected" id="group"><a href="the_group.html" class="tooltip1"><span>The Group</span><span class="hidden-phone tt">Our Intent</span></a>
  ...
  <div class="row-fluid" id="clients_strip">
    ...
    $(document).ready(function(){
     ...
     $('#carousel_ul').stopAuto();
});
$('#carousel_ul').mouseleave(function(){
    $('#carousel_ul').startAuto();
});
