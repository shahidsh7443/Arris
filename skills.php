	...
	<div class="row-fluid">
        ...
        <div class="span7 spann7"><!--Navigation-->
          ...
          <li ><a href="arristraining.php" class="tooltip1">Home<span class="hidden-phone tt">The Genesis</span></a></li>
            <li class="selected "><a href="skills.php" class="tooltip1"><span>Skills</span><span class="hidden-phone tt">Our Abilities</span></a>
            </li>
...
<p class="sep"></p>
  ...
  <h3 class="hh3">Non-Technical Trainings:</h3>
    <div class="table-responsive">
    <table class="table table-responsive" border="1" bordercolor = "black" style="border:1px solid black;">
<thead>
      <tr>
      <th><b>Sales</b></th>
      <th><b>Leadership</b></th>
      <th><b>Behavioural & Soft Skills</b></th>
</tr>
<thead>
  <tbody>
      <td><ul class="ntt">
    <li>Questioning and Listening<br></li>
  <li>Getting a foot in the door<br></li>
    <li>Objection handling<br></li>
    <li>Personality Profiling<br></li>
    <li>Questioning and Listening<br></li>
    <li>Rapport Building<br></li>
    <li>Negotiation mastery<br></li>
    <li>Motive and commitment</li></ul>
  </td>
  <td><ul class="ntt">
    ...
    <li>Build Trust, Credibility, Respect</li></ul>
</td>
<td><ul class="ntt">
...
<li>Success by choice</li>
<li>Presentation Skills</li>
<li>Negotiation Skills</li>
<li>Multi-tasking</li>
<li>Winning thru People</li>
