...
<body>
	...
	<div class="row-fluid">
        ...
        <div class="span7 spann7"><!--Navigation-->
          <ul id="nav" class="js">
          <li class="selected "><a href="arristraining.php" class="tooltip1">Home<span class="hidden-phone tt">The Genesis</span></a></li>
  ...
  <!-- splash image -->
  <div class="container">
<img src="img/Home/training1.png" title="ArrisTrraining" alt="ArrisTrraining"/ class="trainingimg">
  </div>
  ...
  <div class="row-fluid">
        <div class="text_content span10 offset1">
          <!--Text Content-->
<h1>Training:</h1>
  <p>ArrisTrraining has expertise in conducting Training Programs in Corporate and Campus Space drawing upon the vast knowledge and experience of its professional team of well qualified and dedicated training experts and showcases capability of training all industries across all levels of experience right from college students to Executive levels.</p>

  <p>Managed as a professional training company - we offer training programs to Corporates and Colleges. With our vast industry experience and with regular inputs from industry, we identify the courses and tailor them as per industry requirements and assign expert trainers to design and deliver the trainings. We train all industries across all levels of experience right from college students to Executive level prospects.
  </p>
  <p>Below are the lists of skills under which ArrisTrraining conducts training:<br><br>

• Technology Training – industry specific<br>
• Project Management Methodologies <br>
• Sales and Leadership Training across industry<br>
• Behavioural and Soft skills Training across industry
</p>
<p class="sep"></p>
<h3>Our Motto</h3>
  <p>
To deliver skills and knowledge to individuals that significantly increases our trained participants On-The-Job productivity, thereby enhancing their contributions to the goals of the organization.

</p>
<p class="sep"></p>
<h3>Our Vision</h3>
  <p>
Our vision is to be recognized as the training provider of choice in the verticals we serve you, by fostering close relationship with all our clients.</p>
<p class="sep"></p>
    <p>   	“We facilitate you to surpass your competence”<br><br>
       	To know more about our service offerings, <a href="tecclients.php#frmm">please mail us.</a>
