...
$.ajax({
                ...
                error: function( aa ){
                  $("#cbtn").closest("div").append("<span class='error' style='color:White;font-weight:600;display:inline-block;font-size:15px;position:  absolute;margin-top: -65px;margin-left: -125px;'>Thank you for contacting us.</span>");
                  $('#contf')[0].reset();
								}
            });
...
<p class="sep"></p>
              ...
              <form  method="post"  id="contf">
				...
				//unset($_SESSION['error_msg']);?>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4"><input type="email" name="email" id="email" pattern="^[^\s@]+@[^\s@]+\.[^\s@]+$" onkeyup="send_mail1_contact(this.id)" required/></div>
                    </div>
 ...
 <button name="submit" align="center" id="cbtn" class="btn btn-lg btn-warning btn-block" onclick="send_mail1_contact()" type="submit" width="50px" style="margin-top:25px;height:40px;font-size:20px;width: 50%;">Send</button></div>
                    </div>
