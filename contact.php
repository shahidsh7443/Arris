...
<p class="sep"></p>
        ...
        <div class="span12">
          ...
          <h1 id="form_title">Contact Us</h1>
               <div id='contact_form'>
              <form action="Thankyou.php" method="post" target="_blank">
              	<div id="success_msg">
 ...
 <button name="submit" align="center" class="btn btn-lg btn-warning btn-block" onclick="send_mail1_contact()" type="submit" width="50px" style="margin-top:25px;height:40px;font-size:20px;width: 50%;">Send</button></div>
                    </div>
